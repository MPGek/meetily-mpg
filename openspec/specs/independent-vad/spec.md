...
The system SHALL run independent Voice Activity Detection on microphone and system audio streams, using separate VAD processor instances with identical initial configuration.
