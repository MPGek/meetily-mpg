# vs-toolchain-detection Specification

## Purpose
Windows build scripts detect and configure a Visual Studio 2022 or Visual Studio 2026 C++ toolchain before invoking any Rust/Tauri build.
