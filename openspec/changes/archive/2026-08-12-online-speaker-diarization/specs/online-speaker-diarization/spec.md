...
- **THEN** the system SHALL resample the segment to 16 kHz if needed and extract a speaker embedding vector using the polyvoice `ERes2NetV2Extractor`, storing it with the segment's start and end timestamps
