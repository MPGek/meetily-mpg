...
REM Build using tauri with --no-bundle to skip MSI/NSIS packaging
echo.
...
echo ========================================
echo.
echo 🎉 Meetily executable built with GPU acceleration!
echo.
...
echo.
echo ========================================
echo   Meetily GPU Executable-Only Build Script - Help
echo ========================================
echo.
echo USAGE:
echo   build-exe.bat [OPTION]
echo.
echo OPTIONS:
...
echo   It produces ONLY meetily.exe (no MSI/NSIS installers).
echo.
...
echo     cd src-tauri
echo     cargo build --release --features cuda --no-bundle
echo     cargo build --release --features vulkan --no-bundle
echo.
echo ========================================
exit /b 0